...
import com.linkgem.domain.user.*;
...
import com.linkgem.infrastructure.user.UserStore;
...
public class LoginServiceGoogleImpl implements UserLoginService {
    ...
    public LoginResponse login(String providerName, String code) {
        ...
        UserProfile userProfile = getUserProfile(providerName, oauthTokenResponse, provider);
